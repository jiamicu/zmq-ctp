...
class InfoField:
    ...
    def __str__(self):
        # return 'ErrorID:{0}, ErrorMsg:{1}'.format(self.ErrorID,
        # self.ErrorMsg)
...
class OrderField:
    ...
    def __str__(self):
        ...
        return '{self.OrderID}, {self.InstrumentID}, {self.Direction}, {self.Offset}, {self.LimitPrice}, {self.AvgPrice}, {self.InsertTime}, {self.TradeTime}, {self.TradeVolume}, {self.Volume}, {self.VolumeLeft}, {self.Status}, {self.StatusMsg}, {self.IsLocal}, {self.Custom}, {self.SysID}'.format(
            self=self)
        # return '''{{"OrderID": "{self.OrderID}", "InstrumentID":
        # "{self.InstrumentID}", "Direction": "{self.Direction.name}",
        # "Offset": "{self.Offset.name}","LimitPrice": {self.LimitPrice},
        # "AvgPrice": {self.AvgPrice}, "InsertTime": "{self.InsertTime}",
        # "TradeTime": "{self.TradeTime}","TradeVolume": {self.TradeVolume},
        # "Volume": {self.Volume}, "VolumeLeft": {self.VolumeLeft}, "Status":
        # "{self.Status.name}","StatusMsg": "{self.StatusMsg}", "IsLocal":
        # {self.IsLocal}, "Custom": {self.Custom}, "SysID":
        # "{self.SysID}"}}'''.format(self=self)
...
class PositionField:
    ...
    def __str__(self):
        ...
        # return '{{"InstrumentID": "{self.InstrumentID}", "Direction":
        # "{self.Direction.name}", "Price": {self.Price}, "Position":
        # {self.Position},"TdPosition": {self.TdPosition}, "YdPosition":
        # {self.YdPosition}, "CloseProfit":
        # {self.CloseProfit},"PositionProfit": {self.PositionProfit},
        # "Commission": {self.Commission}, "Margin":
        # {self.Margin}}}'.format(self=self)
